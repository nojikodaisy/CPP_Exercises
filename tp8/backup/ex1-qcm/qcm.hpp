...
#define ANSWER_1 true // la copie a été fait avant et en plus évitable en faisant move mais dans 2 on fait copie après
...
#define ANSWER_3 true // on a pas de delete pour les valeurs
...
// Est-ce que l'utilisation de la classe ci-dessus est susceptible de créer des problèmes de mémoire (fuite,
// double-déallocation, etc.) ?
#define ANSWER_5 true // on fait double déallocation car vector d'unique ptr ca delete automatiquement (pas besoin de delete si c pas créer par new)
